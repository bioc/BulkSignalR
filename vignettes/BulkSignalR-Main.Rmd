...
* **BSR-DataModel**, denoted here as `bsrdm`  
* **BSR-Inference**, denoted here as `bsrinf`  
* **BSR-Signature**, denoted here as `bsrsig`
...
method
`BSRInference`. The returned BSR-Inference object,
...
On the top of each individual heatmap, the overall signature score from
